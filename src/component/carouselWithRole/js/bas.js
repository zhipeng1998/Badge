...
// import * as BAS2 from 'three-bas';

var BAS2 = {};

BAS2.ShaderChunk = {};

BAS2.ShaderChunk["animation_time"] =
  "float tDelay = aAnimation.x;\nfloat tDuration = aAnimation.y;\nfloat tTime = clamp(uTime - tDelay, 0.0, tDuration);\nfloat tProgress = ease(tTime, 0.0, 1.0, tDuration);\n";

BAS2.ShaderChunk["catmull-rom"] =
...
BAS2.ShaderChunk["cubic_bezier"] =
  "vec3 cubicBezier(vec3 p0, vec3 c0, vec3 c1, vec3 p1, float t)\n{\n    vec3 tp;\n    float tn = 1.0 - t;\n\n    tp.xyz = tn * tn * tn * p0.xyz + 3.0 * tn * tn * t * c0.xyz + 3.0 * tn * t * t * c1.xyz + t * t * t * p1.xyz;\n\n    return tp;\n}\n";

BAS2.ShaderChunk["ease_in_cubic"] =
  "float ease(float t, float b, float c, float d) {\n  return c*(t/=d)*t*t + b;\n}\n";

BAS2.ShaderChunk["ease_in_out_cubic"] =
  "float ease(float t, float b, float c, float d) {\n  if ((t/=d/2.0) < 1.0) return c/2.0*t*t*t + b;\n  return c/2.0*((t-=2.0)*t*t + 2.0) + b;\n}\n";

BAS2.ShaderChunk["ease_in_quad"] =
  "float ease(float t, float b, float c, float d) {\n  return c*(t/=d)*t + b;\n}\n";

BAS2.ShaderChunk["ease_out_back"] =
  "float ease(float t, float b, float c, float d) {\n  float s = 1.70158;\n  return c*((t=t/d-1.0)*t*((s+1.0)*t + s) + 1.0) + b;\n}\n\nfloat ease(float t, float b, float c, float d, float s) {\n  return c*((t=t/d-1.0)*t*((s+1.0)*t + s) + 1.0) + b;\n}\n";

BAS2.ShaderChunk["ease_out_cubic"] =
  "float ease(float t, float b, float c, float d) {\n  return c*((t=t/d - 1.0)*t*t + 1.0) + b;\n}\n";

BAS2.ShaderChunk["quaternion_rotation"] =
...
BAS2.Utils = {
  ...
  tessellateRepeat: function (geometry, maxEdgeLength, times) {
    for (var i = 0; i < times; i++) {
      BAS2.Utils.tessellate(geometry, maxEdgeLength);
    }
  },
...
BAS2.ModelBufferGeometry = function (model) {
...
BAS2.ModelBufferGeometry.prototype = Object.create(
  THREE.BufferGeometry.prototype
);
BAS2.ModelBufferGeometry.prototype.constructor = BAS2.ModelBufferGeometry;

BAS2.ModelBufferGeometry.prototype.bufferIndices = function () {
...
BAS2.ModelBufferGeometry.prototype.bufferPositions = function () {
...
BAS2.ModelBufferGeometry.prototype.bufferUVs = function () {
...
BAS2.ModelBufferGeometry.prototype.createAttribute = function (name, itemSize) {
...
BAS2.PrefabBufferGeometry = function (prefab, count) {
  THREE.BufferGeometry.call(this);
...
BAS2.PrefabBufferGeometry.prototype = Object.create(
  THREE.BufferGeometry.prototype
);
BAS2.PrefabBufferGeometry.prototype.constructor = BAS2.PrefabBufferGeometry;

BAS2.PrefabBufferGeometry.prototype.bufferIndices = function () {
...
BAS2.PrefabBufferGeometry.prototype.bufferPositions = function () {
  var positionBuffer = this.createAttribute("position", 3).array;
...
// todo test
BAS2.PrefabBufferGeometry.prototype.bufferUvs = function () {
  var prefabFaceCount = this.prefabGeometry.faces.length;
 ...
 */
BAS2.PrefabBufferGeometry.prototype.computeVertexNormals = function () {
...
BAS2.PrefabBufferGeometry.prototype.createAttribute = function (
  name,
  itemSize,
  factory
) {
...
BAS2.PrefabBufferGeometry.prototype.setAttribute4 = function (name, data) {
  var offset = 0;
...
BAS2.PrefabBufferGeometry.prototype.setAttribute3 = function (name, data) {
  var offset = 0;
  var array = this.geometry.attributes[name].array;
  var i, j;
...
BAS2.PrefabBufferGeometry.prototype.setAttribute2 = function (name, data) {
  var offset = 0;
  var array = this.geometry.attributes[name].array;
  var i, j;
...
BAS2.BaseAnimationMaterial = function (parameters) {
...
BAS2.BaseAnimationMaterial.prototype = Object.create(
  THREE.ShaderMaterial.prototype
);
BAS2.BaseAnimationMaterial.prototype.constructor = BAS2.BaseAnimationMaterial;

// abstract
BAS2.BaseAnimationMaterial.prototype._concatVertexShader = function () {
  return "";
};

BAS2.BaseAnimationMaterial.prototype._concatFunctions = function () {
  return this.shaderFunctions.join("\n");
};
BAS2.BaseAnimationMaterial.prototype._concatParameters = function () {
  return this.shaderParameters.join("\n");
};
BAS2.BaseAnimationMaterial.prototype._concatVertexInit = function () {
  return this.shaderVertexInit.join("\n");
};
BAS2.BaseAnimationMaterial.prototype._concatTransformNormal = function () {
  return this.shaderTransformNormal.join("\n");
};
BAS2.BaseAnimationMaterial.prototype._concatTransformPosition = function () {
  return this.shaderTransformPosition.join("\n");
};

BAS2.BaseAnimationMaterial.prototype.setUniformValues = function (values) {
...
BAS2.BasicAnimationMaterial = function (parameters, uniformValues) {
  BAS2.BaseAnimationMaterial.call(this, parameters);
...
BAS2.BasicAnimationMaterial.prototype = Object.create(
  BAS2.BaseAnimationMaterial.prototype
);
BAS2.BasicAnimationMaterial.prototype.constructor = BAS2.BasicAnimationMaterial;
// console.log(this, 'this');
BAS2.BasicAnimationMaterial.prototype._concatVertexShader = function () {
  ...
  return [
    ...
    // console.log(this._concatFunctions()),
...
BAS2.PhongAnimationMaterial = function (parameters, uniformValues) {
  BAS2.BaseAnimationMaterial.call(this, parameters);
...
BAS2.PhongAnimationMaterial.prototype = Object.create(
  BAS2.BaseAnimationMaterial.prototype
);
BAS2.PhongAnimationMaterial.prototype.constructor = BAS2.PhongAnimationMaterial;

BAS2.PhongAnimationMaterial.prototype._concatVertexShader = function () {
  // based on THREE.ShaderLib.phong
  return [
    "#define PHONG",
