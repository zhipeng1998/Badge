  ...
  useLayoutEffect(() => {
    var canvasSmoke = function (canvas, options) {
      var defaults = {
        ...
        velocity: 4,
        fps: 30,
        url: "https://raw.githubusercontent.com/tangxiaolang101/PhysicalCanvas/master/smoke.png",
      };
      ...
      function Particle(context) {
        ...
        this.draw = function () {
          ...
          if (this.image) {
            ...
            // 烟雾缭绕就看这里了
            // 这是宽度，是动态的
            var fillWidth = canvasWidth,
              fillHeight = canvasHeight;
            // fillWidth -
            // fillWidth * (((this.x / canvasWidth) * this.y) / canvasHeight);
